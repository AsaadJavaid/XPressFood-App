import { StyleSheet, Text, View, ScrollView, Dimensions, TouchableOpacity , ImageBackground, Modal} from 'react-native'
...
import MenuScreen from './ResraurantsTabs/MenuScreen'
    ...
    return (
        <View style  = {styles.container}>
            <ScrollView>
                <View>
                    ...
                    {restaurantsData[id].discount &&
                        <View style = {styles.view1}>
                            <Text style = {styles.text1}>GET {restaurantsData[id].discount}% OFF ON YOUR ORDER</Text>
                        </View>
                    }
                ...
                {/* <TouchableOpacity
                onPress={()=>{
                    navigation.navigate("FastFoodResult")
                }}
                >
                    <View>
                        <ImageBackground
                ...
                <TouchableOpacity
                    onPress={()=>{
                        navigation.navigate("PizzaResult")
                    }}
                >
