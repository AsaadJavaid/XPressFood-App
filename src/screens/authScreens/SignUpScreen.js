  ...
  return (
    <View style = {styles.container}>
        ...
        >
            ...
            <Formik
                initialValues ={initialValues} onSubmit = {(values)=>{signUp(values)}}
            >
                { (props)=>(
                    <View style = {styles.view2}>
                        <View>
                            <Text style = {styles.text2}>New on XpressFood ???
...
const styles = StyleSheet.create({
    ...
    container:{flex:1,
      ...
      input1:{fontSize:16, color : "white"},
    ...
    text5:   {fontSize:15,
      ...
      button2:{backgroundColor: "#7fffd4",
        alignContent:"center",
        justifyContent:"center",
        borderRadius:12,
        borderWidth:1, 
